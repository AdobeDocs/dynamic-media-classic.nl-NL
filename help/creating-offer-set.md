...
description: Leer hoe u een set voorstellen maakt.
...
Voor malplaatjes, klik **[!UICONTROL Add and Preview]**, dan plaats de parameters u kiest. De andere soorten aanbiedingsreeksen omvatten geen parameters, maar u kunt hen nog aanpassen door **[!UICONTROL Preview]** te klikken en de beschikbare voorinstellingen te veranderen.
...
1. Klik op **[!UICONTROL Build]** > **[!UICONTROL Test&Target Offer Set]**.
...
1. Selecteer het object en klik op **[!UICONTROL Add & Preview]**.
...
1. Klik **[!UICONTROL **Save]** of **[!UICONTROL Save As**]** om de aanbieding als deel van de aanbiedingsreeks op te slaan.
...
1. Klik **[!UICONTROL Close]**, ga een naam voor de aanbiedingsreeks in, en klik dan **[!UICONTROL Save]**.
...
1. Stel afbeeldingen of video&#39;s samen voor de ingestelde aanbieding. Begin in het Test&amp;Target Vastgestelde scherm van de Aanbieding of in de Mening van het Net of de Mening van de Lijst en gebruik één van de volgende methodes:
   ...
   * **Scherm**  instellen &amp;doelaanbieding testen - Klik  **[!UICONTROL Build]** >  **[!UICONTROL Test&Target Offer Set]**. Sleep afbeeldingen of video&#39;s naar het scherm. Als u video&#39;s of afbeeldingen van verschillende grootten wilt maken, sleept u in meerdere exemplaren van de afbeelding of video en stelt u elke grootte afzonderlijk in.

   * **Rasterweergave of Lijstweergave**  - Selecteer de afbeeldingen of video&#39;s en klik op  **[!UICONTROL Build]** >  **[!UICONTROL Test&Target Offer Set]**.

1. Selecteer desgewenst een afbeelding of video en klik op **[!UICONTROL Preview]**. Op de pagina Voorvertoningsaanbiedingen kunt u de grootte en het uiterlijk wijzigen van de afbeelding of video die u hebt geselecteerd. U kunt ook alle afbeeldingen of video&#39;s in de set met aanbiedingen wijzigen.

   * Kies een voorinstelling om het uiterlijk en de grootte van de afbeelding of video te wijzigen.
   * Als u de voorinstelling die u hebt gekozen, wilt toepassen op alle aanbiedingen in de aanbiedingsset, klikt u op het selectievakje **[!UICONTROL Select Presets to All]**.

   Klik **[!UICONTROL Save]** om uw veranderingen in het beeld of de videoaanbieding te bewaren. Klik vervolgens op **[!UICONTROL Close]** om terug te keren naar de pagina Set Test&amp;Target-aanbiedingen.
...
1. Klik **[!UICONTROL Save]** en ga een naam voor de aanbiedingsreeks in, en klik **[!UICONTROL Save]**.
...
1. Als u een aanbiedingsset wilt bewerken, geeft u de aanbieding weer die is ingesteld in de rasterweergave of lijstweergave en klikt u op de desbetreffende **[!UICONTROL Edit]**-rolloverknop.
1. Voer een of meerdere van de volgende handelingen uit op de pagina Set voorstel testen&amp;Doel:

   * **Een aanbieding**  verwijderen - Selecteer de aanbieding en klik vervolgens  **[!UICONTROL Delete]** om een aanbieding uit de set te verwijderen.
   * **Een aanbieding**  toevoegen - Hoe je een aanbieding toevoegt, hangt af van het soort voorstel dat je gebruikt:
      * **Sjablonen**  - Klik  **[!UICONTROL Add & Preview]** en maak een andere aanbieding op de pagina Aanbiedingen toevoegen en voorvertonen.
      * **Afbeeldingen en video** : sleep een afbeelding of video naar de pagina Set Test&amp;Target-aanbiedingen.

   >[!NOTE]
   >
   >U kunt geen aanbiedingsreeks schrappen die met een campagne wordt geassocieerd. Als u een set aanbiedingen die aan een campagne is gekoppeld wilt verwijderen, meldt u zich aan bij Adobe Target Standard/Premium en verwijdert u eerst de campagnecorracties. Zelfs nadat u zich niet aan een campagne hebt gekoppeld, kunt u het middel alleen verwijderen uit Dynamic Media Classic. Hiervoor is een aanmelding bij Adobe Target Standard/Premium vereist en niet vanuit Adobe Target Standard/Premium.
...
1. Klik op de algemene navigatiebalk op **[!UICONTROL File]** > **[!UICONTROL Delete]** > **Delete**.
