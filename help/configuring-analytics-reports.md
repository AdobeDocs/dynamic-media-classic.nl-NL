...
* **Bewerken**  - Selecteer een viewergebeurtenis en selecteer de grijze knop  **[!UICONTROL View/Edit]** Variabelen. Kies in de vervolgkeuzelijst Klassieke variabele Dynamic Media en Adobe Analytics-variabele een andere variabele uit elke respectievelijke lijst. Zie [Adobe Analytics-variabelen toewijzen aan Klassieke Dynamic Media-viewergebeurtenissen en -variabelen](#assigning-adobe-analytics-variables-to-scene-viewer-events-and-variables) voor meer informatie.
