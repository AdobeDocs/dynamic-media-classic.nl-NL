...
1. Selecteer in het dialoogvenster Bestanden **selecteren die u wilt uploaden** het door tabs gescheiden of XML-bestand met de metagegevens.
...
* Eigenschappen van XMP-metagegevens moeten het gerelateerde XMP-voorvoegsel hebben vóór de naam (eigenschap-). Een dubbele punt scheidt het voorvoegsel en de naam. U vindt het voorvoegsel XMP in Setup > Application Setup > Metadata > Metadata Schema editor. De technische namen vindt u in de documentatie bij het gerelateerde XMP-schema. Namen van XMP-eigenschappen worden niet weergegeven in de functie Bestand genereren.
...
**XMP-metagegevens en XMP-bestanden voor metagegevensschema&#39;s importeren**

De XML-import accepteert alleen geldige XML. Bij het importeren van XMP- of metagegevensschemavelden wordt het naamruimtevoorvoegsel toegevoegd en gedraagt het zich hier als een XMP-naamruimte. Deze naamruimte moet bijvoorbeeld in de tag op hoofdniveau worden gedeclareerd.
...
| Verwijderen | Hiermee verwijdert u een eigenschap of keuzevrijheid uit het schema. Hiermee verwijdert u geen waarden uit het XMP-blok of de database. De eigenschap is niet meer beschikbaar voor weergaven van metagegevens en wordt verwijderd uit de weergave Details van element. Als de eigenschap is gepubliceerd naar de server met metagegevens, voert u een kracht uit die publiceert om de gegevens te verwijderen uit de openbare metagegevensserver. |
...
Eigenschappen beschrijven de metagegevens die met dit schema in het XMP-blok kunnen worden opgeslagen. Een eigenschap bestaat uit:
