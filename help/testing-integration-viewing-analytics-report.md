...
1. Start een Dynamic Media Classic viewer vanaf uw account, met name een viewer die de metrische gegevens uitzendt die u wilt vastleggen, en communiceer ermee om gebeurtenisgegevens te maken.
...
1. Bekijk het diagram dat door Adobe Analytics is gemaakt. Merk op dat dit typisch enkel de gegevens voor één enkele metrisch is. Als u ook wilt weten met welk element deze gegevens zijn gekoppeld (bijvoorbeeld welke video naar slechts 50% wordt gecontroleerd of welke afbeelding in een set het populairst is), moet u ook de elementgegevens van deze gebeurtenis vastleggen.
