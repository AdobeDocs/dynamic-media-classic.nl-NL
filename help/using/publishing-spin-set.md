...
Markeer de centrifugeset voor publicatie zodat deze naar Adobe Dynamic Media Classic Image Servers kan worden gekopieerd. U kunt de centrifugeset markeren voor publicatie in het deelvenster Bladeren door het pictogram **[!UICONTROL Mark for Publish]** links van de naam te selecteren. Alle afbeeldingen in de set worden gemarkeerd voor publicatie wanneer u de paginaset markeert voor publicatie.

## De centrifugeset publiceren {#publishing-the-spin-set}

Selecteer **[!UICONTROL Publish]** als u een centrifuge wilt publiceren die is ingesteld op Dynamic Media Image Servers op de algemene navigatiebalk. Selecteer vervolgens een optie **[!UICONTROL When]** . U kunt desgewenst een naam voor de publicatietaak invoeren. Selecteer **[!UICONTROL Submit Publish]** .
