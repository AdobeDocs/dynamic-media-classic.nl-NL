...
1. Voer een van de volgende handelingen uit op de pagina Voorinstellingen viewer:
   ...
   * Selecteer **[!UICONTROL Add]** als u een voorinstelling wilt maken. Kies een platform in het dialoogvenster Voorinstelling viewer toevoegen. Klik vervolgens op **[!UICONTROL Mixed Media Set Viewer]** > **[!UICONTROL Add]** .
   * Als u een voorinstelling voor een gemengde mediaset wilt bewerken, selecteert u deze en selecteert u vervolgens **[!UICONTROL Edit]** .
...
1. Typ in het vak **[!UICONTROL Name]** een naam voor de viewer die u wilt toevoegen.
...
1. Selecteer in het menu Voorinstelling een voorinstelling voor het gekozen elementtype.
   ...
   Als u bijvoorbeeld een stalenset toevoegt, selecteert u **[!UICONTROL SwatchSet1-Colors]** .
...
1. Als u communityfuncties (Insluiten, Koppeling, Bezoek) wilt toevoegen aan de viewer, geeft u opties op voor een van de volgende opties:
   ...
   * **bed** in: Selecteer **[!UICONTROL Live]**. Typ in het vak Label van knop insluiten de naam die u in de viewer voor de knop Insluiten wilt weergeven. Selecteer desgewenst **[!UICONTROL Browse]** om een aangepaste skin voor de knop te zoeken en te selecteren.

   * **Verbinding**: Selecteer **[!UICONTROL Live]**. Typ in het vak Label van koppelingsknop de naam die u wilt weergeven in de viewer voor de knop Koppelen. Selecteer desgewenst **[!UICONTROL Browse]** om een aangepaste skin voor de knop te zoeken en te selecteren.
