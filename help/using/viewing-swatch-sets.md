...
1. Voer een van de volgende handelingen uit:
   ...
   * Selecteer **[!UICONTROL Add]** als u een voorinstelling wilt maken. Kies in het dialoogvenster Voorinstelling viewer toevoegen in de vervolgkeuzelijst Viewer de optie **[!UICONTROL Swatch Set Viewer]** en selecteer vervolgens **[!UICONTROL Add]** .
   * Als u een bestaande voorinstelling voor een Staalset-viewer wilt bewerken, selecteert u de voorinstelling en selecteert u vervolgens **[!UICONTROL Edit]** .
...
1. Selecteer **[!UICONTROL Close]** om terug te keren naar de Assets-pagina.
