...
* Geef in het deelvenster Bladeren de afbeelding weer in **[!UICONTROL Detail View]** en selecteer vervolgens **[!UICONTROL Zoom Targets]** .

Selecteer in het scherm Zoomdoel-editor de knop **[!UICONTROL Select Target]** (pijl) om een doel te selecteren voordat u het formaat of de positie wijzigt. Selecteer **[!UICONTROL Add Targets]** (rechthoek) om een zoomdoel voor de afbeelding te maken. Op de pagina Zoomdoeleditor vindt u ook gereedschappen voor het verwijderen, kopiëren en benoemen van zoomdoelen.
...
1. Selecteer **[!UICONTROL Add Targets]** (rechthoek), verplaats de aanwijzer boven de afbeelding en selecteer waar het zoomdoel moet komen.

   Er wordt een miniatuurafbeelding van het zoomdoel weergegeven in het deelvenster aan de rechterkant van het scherm.

1. Kies **[!UICONTROL Select Target]** (pijl), selecteer het zoomdoel dat u hebt gemaakt en pas de grootte en positie van het doel aan.

   * **vergroot** opnieuw: Beweeg de wijzer over een hoek van het gezoemdoel en sleep om het doel te vergroten of te krimpen.

   * **Positie**: Beweeg de wijzer over het gezoemdoel en sleep het aan een verschillende plaats.
...
* **Verplaatsing**: met de Uitgezochte knoop van het Doel (de pijl), selecteer het doel. Sleep het doel vervolgens naar een andere locatie.

* **Resize**: Met de Uitgezochte knoop van het Doel (de pijl), selecteer het doel. Als u het doel wilt vergroten of verkleinen, plaatst u de aanwijzer boven een hoek van het zoomdoel en sleept u.

* **Schrapping**: Selecteer het duimnagelbeeld van het doel op de rechterkant van het scherm. Selecteer vervolgens **[!UICONTROL Delete Target]** .

* **die** anders noemen: Selecteer het duimnagelbeeld van het doel op de rechterkant van het scherm. Voer vervolgens een naam in het tekstveld **[!UICONTROL Name]** in en selecteer **[!UICONTROL Save]** .
