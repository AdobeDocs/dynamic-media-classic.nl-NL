...
Nadat u een Reeks van het Beeld publiceert, kunt u zijn bijbehorende URL of zijn ingebed code voor gebruik in uw Website of toepassing kopiëren. Dan kunt u URL opstellen of de ingebedde code kleven zonodig zodat kunnen de gebruikers het Beeld bekijken dat op uw Website of toepassing wordt geplaatst.
...
1. Selecteer **[!UICONTROL Image Set]** in de vervolgkeuzelijst Tonen in het deelvenster Asset Browse.
...
1. Voer boven het deelvenster Asset Browse een van de volgende handelingen uit aan de rechterkant van de werkbalk:
   ...
   * Selecteer **[!UICONTROL Grid View]** . Dubbelklik in het deelvenster Asset Browse op één element om dit te openen in de gedetailleerde weergave. Selecteer in het deelvenster **[!UICONTROL URLs and Embed Code]** aan de rechterkant **[!UICONTROL Copy URL]** rechts van de gewenste viewer.
...
Voor meer details en codesteekproeven, zie de [ Ingebedde Kijker van het Gezoem HTML5 ](https://experienceleague.adobe.com/en/docs/dynamic-media-developer-resources/library/viewers-aem-assets-dmc/zoom/c-html5-20-zoom-viewer-about#section-e1c3106f5b3e445d9b95be337c2f94e2) in de Gids van de Verwijzing van de Kijkers van Adobe.

## De ingesloten code van een viewer voor een afbeeldingsset kopiëren {#copying-the-embed-code-of-an-image-set-viewer}

Met de ingesloten codefunctie kunt u de viewercode voor de geselecteerde afbeeldingsset controleren. U kunt de code aan het klembord ook kopiëren zodat kunt u het in uw Web-pagina&#39;s voor plaatsing van de kijker kleven. U mag de code niet bewerken in het dialoogvenster Code insluiten.

**om de ingebedde code van een Vastgestelde kijker van het Beeld te kopiëren:**

1. Selecteer **[!UICONTROL Image Set]** in de vervolgkeuzelijst Tonen in het deelvenster Asset Browse.
1. Navigeer in het deelvenster Elementenbibliotheek aan de linkerkant naar de elementenmap die de Afbeeldingsset bevat waarvan u de ingesloten code wilt kopiëren.
1. Voer boven het deelvenster Asset Browse een van de volgende handelingen uit aan de rechterkant van de werkbalk:
   ...
   * Selecteer **[!UICONTROL Grid View]**, **Mening van de Lijst**, of **Mening van het Detail**. Ga op dezelfde werkbalk naar **[!UICONTROL Preview]** > **[!UICONTROL Viewer List]** .

     Selecteer **[!UICONTROL Embed Code]** onder de kolom Acties van de tabel op de pagina Viewer List.

1. Selecteer **[!UICONTROL Embed Code]** in het dialoogvenster **[!UICONTROL Copy to Clipboard]** .

   Het bewerken van de code is niet toegestaan in het dialoogvenster **[!UICONTROL Embed Code]** .
