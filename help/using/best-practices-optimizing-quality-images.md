...
Zie ook [ Slimme beeldvorming ](https://experienceleague.adobe.com/en/docs/experience-manager-65/content/assets/dynamic/imaging-faq).
...
De beste praktijken whitepaper in PDF riep [ scherp beelden in Adobe Dynamic Media Classic en op de Server van het Beeld ](/help/using/assets/s7_sharpening_images.pdf).
