...
Wanneer u zoom-afbeeldingen publiceert, worden deze op Dynamic Media Image Servers geplaatst, zodat ze ter beschikking kunnen worden gesteld van uw website en toepassing. Als onderdeel van het publicatieproces activeert Adobe Dynamic Media Classic de URL-tekenreeksen. U kunt deze URL-tekenreeksen in de HTML-code van uw website plaatsen.
...
Als u zoomafbeeldingen wilt publiceren, selecteert u op de algemene navigatiebalk **[!UICONTROL Publish]** en selecteert u vervolgens een **[!UICONTROL When]** -optie ( **[!UICONTROL One-Time]** of **[!UICONTROL Recurring]** ). U kunt desgewenst een naam voor de publicatietaak invoeren. Selecteer **voorleggen publiceer**.
