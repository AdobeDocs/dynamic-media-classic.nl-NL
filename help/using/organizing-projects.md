...
Nadat u een projectmap hebt gemaakt, kunt u er elementen in plaatsen. Assets in een project zijn in feite aanwijzers naar de map Asset Library waarin de elementen zijn opgeslagen. U kunt een middel in meer dan één Project plaatsen. Een afbeelding van een bloe kan bijvoorbeeld zowel in de projectmappen &quot;Blouses&quot; als &quot;Fall Collection&quot; worden geplaatst.
...
U kunt een projectmap maken die begint in de Assets-bibliotheek of wanneer u bestanden uploadt naar Adobe Dynamic Media Classic:

* **in de Bibliotheek van Activa**: De rol aan de bodem van de Bibliotheek van Activa, aan de sectie van Projecten, en selecteert dan **[!UICONTROL Add Project]**. Voer een naam in voor het project.

* **wanneer het uploaden van dossiers**: Op het Upload scherm, ga **[!UICONTROL Add to Project]** > **[!UICONTROL Create Project]**. Voer een naam in voor het project.
...
* **het Bladeren inhoud**: Selecteer de naam van de omslag in de Bibliotheek van Activa. De bijbehorende elementen worden weergegeven in het deelvenster Bladeren.

* **het Schrappen van de omslagen van het Project**: Selecteer de omslag van het Project en selecteer dan **[!UICONTROL Remove Project]**. Als u elementen uit een projectmap verwijdert, worden deze niet uit Adobe Dynamic Media Classic verwijderd. De elementen blijven in de oorspronkelijke mappen staan waarin ze zijn opgeslagen.

* **die de omslagen van het Project** anders noemen: Dubbelklik de naam van de omslag in het Comité van Activa, en ga dan een nieuwe naam in.
...
* **van het Browse paneel**, selecteer de activa en sleep hen aan een omslag van het Project. U kunt ook naar **[!UICONTROL File]** > **[!UICONTROL Add To Project]** gaan. Selecteer de naam van een projectmap in het dialoogvenster Project selecteren en selecteer vervolgens **[!UICONTROL Submit]** .

* **wanneer het uploaden van dossiers**: Voor de Upload pagina, selecteer **[!UICONTROL Job Options]**. Selecteer **[!UICONTROL Projects]** in het dialoogvenster Taakopties uploaden en selecteer vervolgens een projectnaam.
