...
Deze snelle start is ontworpen om u snel aan de slag te krijgen met de in Adobe Dynamic Media Classic gebruikte technieken voor het draaien van spinnen. Voer stap 1 tot en met 7 uit. Aan het eind van elke stap, kunt u een onderwerpverbinding selecteren om meer te leren.
...
Zie [&#x200B; publiceren een Reeks van de Rotatie &#x200B;](publishing-spin-set.md#publishing-a-spin-set).
