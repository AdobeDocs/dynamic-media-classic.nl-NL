...
## De videoviewer toevoegen op een webpagina {#embedding-the-video-viewer-on-a-web-page}

Gebruik de ingesloten codefunctie wanneer u de video wilt afspelen die is ingesloten op de webpagina. U kopieert de ingesloten code naar het klembord, zodat u deze op uw webpagina&#39;s kunt plakken. U mag de code niet bewerken in het dialoogvenster Code insluiten.
...
1. Plak de ingesloten code in uw webpagina&#39;s.
...
Zie [&#x200B; Beeld Servend Gids &#x200B;](https://experienceleague.adobe.com/en/docs/dynamic-media-developer-resources/image-serving-api/image-serving-api/c-is-home#image-serving-api).
