...
Zie [Statische (niet-afbeeldings) inhoud](https://marketing.adobe.com/resources/help/en_US/s7/is_ir_api/is_api/c_serving_static_nonimage_contents.html) in de Help *van de* Adobe Image Serving API voor meer informatie over het gebruik van de JSON-functie in een URL.
